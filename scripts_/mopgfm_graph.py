...
cond_samples_path = Path('data/thesis/polymnist/mopgfm/cond_gen_single_imgs')
...
pic.set_node(text=nodes.q1_tilde, options='m0_dis, right of=gfm1, xshift=0.75cm', name='q1_tilde')
...
pic.set_line('q1', 'gfm1', label=r'\textcolor{green}{$\mu_1$}', edge_options='bend right=-10', label_pos='south')
pic.set_line('q1', 'gfm1', label=r'\textcolor{green}{$\sigma_1$}', edge_options='bend right=10', label_pos='north')

pic.set_line('q1', 'gfm12', edge_options='bend right=-10')
pic.set_line('q1', 'gfm12', edge_options='bend right=10')
pic.set_line('q2', 'gfm12', edge_options='bend right=10')
pic.set_line('q2', 'gfm12', edge_options='bend right=-10')

pic.set_line('q2', 'gfm2', label=r'\textcolor{orange}{$\mu_2$}', edge_options='bend right=10', label_pos='north')
pic.set_line('q2', 'gfm2', label=r'\textcolor{orange}{$\sigma_2$}', edge_options='bend right=-10', label_pos='south')
