...
pic.set_node(text=nodes.output__m1m2_m1, options='above of=output__m1m2_m2, yshift=1.5cm', name='output__m1m2_m1')
pic.set_node(text=nodes.output__m2_m1, options='above of=output__m1m2_m1, yshift=1.5cm', name='output__m2_m1')
pic.set_node(text=nodes.output__m1_m2, options='below of=output__m1m2_m2, yshift=-1.5cm', name='output__m1_m2')
...
pic.set_line('z', 'output__m1m2_m1', label=r'$dec_1$\ ', label_pos='south', edge_options='bend left=30')
