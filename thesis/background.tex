...
We also compare to the \mg{PoE} which is seen as the gold standard for aggregating information across modalities and the \mg{MoE} for learning each modality equaly well.
...
\subsection{Importance Weighted Autoencoder} \label{subsec:iwvae}
...
\begin{figure}
    ...
    \caption{Flowchart depicting the workings of a coupling block, taken from the ECCV2020's Tutorial: "Introduction to Normalizing Flows" from Marcus A. Brubaker (\url{https://youtu.be/u3vVyFVU\_lI})}
